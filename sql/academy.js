...
(function () {
    ...
    $(SCREEN).innerHTML = `
      <main class="stage">
        ...
        <section class="work">
          ...
          <div class="work-head">
            <span class="tab">🎓 <span class="tab-name">Training query</span></span>
  ...
  function render() {
    ...
    if (stage === "teach") {
      ...
      // renderRef dispatches by kind: a "query" artifact renders as a SQL console,
      // anything else as a sheet. Pass every highlight key — each renderer reads
      // the ones it understands (query/viz use `highlight`; sheet uses the rest).
      SACore.renderRef($("#a-sheet"), ex, {
